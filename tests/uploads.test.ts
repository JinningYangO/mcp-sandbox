import fs from 'fs';
import type { ResponseLike } from 'mcp-sandbox-api/internal/to-file';
import { toFile } from 'mcp-sandbox-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('mcp-sandbox-api/core/uploads');
    await expect(
